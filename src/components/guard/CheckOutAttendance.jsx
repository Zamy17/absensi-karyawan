// src/components/guard/CheckOutAttendance.jsx (Optimized for mobile)
    ...
    return (
      <div className="space-y-3">
        {filteredEmployees.map((employee) => {
          const canCheckout = canEmployeeCheckOut(employee.id);
          ...
          return (
            <div 
              ...
              onClick={() => canCheckout && handleSelectEmployee(employee)}
            >
                  ...
                  {filteredEmployees.length === 0 ? (
                    ...
                    filteredEmployees.map((employee) => (
                      <tr key={employee.id}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          {getAttendanceStatusText(employee)}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <Button
